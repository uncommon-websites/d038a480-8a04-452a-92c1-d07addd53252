...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Sarah Chen",
		role: "Founder & CEO",
		image: "/generated/image-documentary-style-waist-up-portrait-of-a.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I watched brilliant developers abandon their product vision because they hit the ML complexity wall. They weren't building features anymore—they were wrestling with infrastructure. That's when I knew we had to make AI integration feel as natural as calling any other API."`}
			/>
